import EventCard, { EventCardProps } from "../../components/Programme/EventCard";
...
type ProgrammeEvent = Omit<EventCardProps, "isFavorite" | "onToggleFavorite" | "onClick">;
